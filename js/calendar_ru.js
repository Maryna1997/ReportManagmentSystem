...
document.write('<table id="fc" style="position:absolute; z-index:100;border-collapse:collapse;background:#00008B;border:1px solid #00008B;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding="2">');
...
document.write('<tr style="background:#00008B;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#00008B" onclick="today()">Сьогодні: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function f_cps(obj) {
	...
	obj.style.border='1px solid #00008B';//'1px solid #606060';
